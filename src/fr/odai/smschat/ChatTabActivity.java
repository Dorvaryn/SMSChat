...
import fr.odai.smschat.fragment.ChatContactFragment;
import fr.odai.smschat.fragment.RoomDetailFragment;

public class ChatTabActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_room_tab);
		room_id = getIntent().getExtras().getLong("room_id");
	...
	private void initialiseTabHost(Bundle args) {
		...
		ChatTabActivity.addTab(
				...
				(tabInfo = new TabInfo("Contacts",
						ChatContactFragment.class, args)));
		this.mapTabInfo.put(tabInfo.tag, tabInfo);
	 ...
	 *            infos de la � cr�er
	 */
	private static void addTab(ChatTabActivity activity, TabHost tabHost,
	...
	protected void onResume() {
		super.onResume();
		room_id = getIntent().getExtras().getLong("room_id");
		setTitle(DBHelper.getRoom(getBaseContext(), room_id).name);
	}
