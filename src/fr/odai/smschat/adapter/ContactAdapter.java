...
public class ContactAdapter extends ArrayAdapter<DisplayContact> {

	private HiddenQuickActionSetup mQuickActionSetup;
	
	public ContactAdapter(Context context, int textViewResourceId, ArrayList<DisplayContact> contacts, HiddenQuickActionSetup setup) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DisplayContact contact = getItem(position);
